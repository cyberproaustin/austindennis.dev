...
- [x] Add 26 owner-supplied credentials, split into 13 current-focus and 13 collapsed background entries on Expertise, with three featured certifications on the homepage. Exclude the expired Tenable MSSP and Thinkful entries.
